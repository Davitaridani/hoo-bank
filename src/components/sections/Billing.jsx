		...
		<section id="product" className={layouts.sectionReverse}>
			...
			<div className={layouts.sectionInfo}>
				...
				<div className="flex flex-row flex-wrap sm:mt-10 mt-6">
					<img src={apple} alt="apple_playSotre" className="w-[128px] h-[42px] object-contain mr-5 cursor-pointer" />
					<img src={google} alt="google_playSotre" className="w-[128px] h-[42px] object-contain cursor-pointer" />
				</div>
			</div>
		</section >
	)
